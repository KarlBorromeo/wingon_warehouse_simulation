...
rear_left_steer_motor = robot.getDevice("rear_left_steer_motor")
rear_right_steer_motor = robot.getDevice("rear_right_steer_motor")
...
slider_motor.setPosition(0.001)
...
while robot.step(timestep) != -1:
    ...
    if key == ord('W'):
        ...
        rear_left_steer_motor.setPosition(-1.0)
        rear_right_steer_motor.setPosition(-1.0)
